import PrivacyPolicyForm from "@/components/Admin/PrivacyPolicyForm/PrivacyPolicyForm";
...
function PrivacyPolicy() {
  ...
  const handelDelete = async (id: string) => {
    if (id) {
      const deleteService = doc(db, "storeSetting", docId, "PrivacyPolicy", id);
      setIsLoading(true);
  ...
  return (
    <div>
      ...
      >
        <Box p="2">
          <Heading size="md">Manage Privacy Policy</Heading>
        </Box>
        <Spacer />
      ...
      {isLoading ? (
        ...
        <>
          {privacyPolicyList &&
            privacyPolicyList.map((data, index) => {
              return (
      ...
      >
        ...
        <ModalContent>
          <ModalHeader>
            {editId ? "Edit Privacy Policy" : "Add Privacy Policy"}
          </ModalHeader>
          <ModalCloseButton />
          <ModalBody>
            <PrivacyPolicyForm modelClose={onClose} editId={editId} />
          </ModalBody>
        </ModalContent>
      </Modal>
    </div>
